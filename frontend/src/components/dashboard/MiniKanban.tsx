...
const COLUMNS: { status: TaskStatus; label: string; dotColor: string }[] = [
  ...
  { status: "completed", label: "Completed", dotColor: "#00ff88" },
...
function TaskCard({
  ...
  return (
    <motion.div
      ...
      className="glass rounded-xl p-3 card-shine cursor-pointer group hover:border-white/10 transition-all"
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-mono font-bold" style={{ color: isProfit ? "#00ff88" : "#ff4466" }}>
          ...
          return (
            <div key={col.status} className="w-56 shrink-0">
              ...
              <div className="space-y-2">
                ...
                {colTasks.length === 0 && (
                  <div className="glass rounded-xl p-4 text-center text-[10px] text-gray-500">
                    No tasks
                  </div>
                )}
              </div>
